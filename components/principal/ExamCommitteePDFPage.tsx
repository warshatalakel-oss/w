...
interface ExamCommitteePDFPageProps {
    settings: SchoolSettings;
    members: CommitteeMember[];
    tasks: string;
}

export default function ExamCommitteePDFPage({ settings, members, tasks }: ExamCommitteePDFPageProps) {
    return (
        <div className="w-[794px] h-[1123px] bg-white p-12 flex flex-col font-['Cairo']" dir="rtl">
            <header className="text-center mb-10">
                <h1 className="text-3xl font-bold">
                    اللجنة الامتحانية واعمالها للعام الدراسي {settings.academicYear}
                </h1>
            </header>

            <main className="flex-grow">
                <h2 className="text-2xl font-bold mb-4">أعضاء اللجنة الامتحانية:</h2>
